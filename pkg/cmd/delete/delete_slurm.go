...
func NewSlurmCmd(clientGetter helpers.ClientGetter, streams genericiooptions.IOStreams) *cobra.Command {
...
func (o *SlurmOptions) Complete(clientGetter helpers.ClientGetter, cmd *cobra.Command, args []string) error {
	o.JobNames = args
