...
func NewRayClusterCmd(clientGetter helpers.ClientGetter, streams genericiooptions.IOStreams) *cobra.Command {
...
func (o *RayClusterOptions) Complete(clientGetter helpers.ClientGetter, cmd *cobra.Command, args []string) error {
