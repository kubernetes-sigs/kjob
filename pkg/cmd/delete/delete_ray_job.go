...
func NewRayJobCmd(clientGetter helpers.ClientGetter, streams genericiooptions.IOStreams) *cobra.Command {
...
func (o *RayJobOptions) Complete(clientGetter helpers.ClientGetter, cmd *cobra.Command, args []string) error {
	o.RayJobNames = args
