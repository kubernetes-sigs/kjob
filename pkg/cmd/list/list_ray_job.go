...
func NewRayJobCmd(clientGetter helpers.ClientGetter, streams genericiooptions.IOStreams, clock clock.Clock) *cobra.Command {
...
func (o *RayJobOptions) Complete(clientGetter helpers.ClientGetter) error {
	var err error
