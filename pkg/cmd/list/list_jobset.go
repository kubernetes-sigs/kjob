...
func NewJobSetCmd(clientGetter util.ClientGetter, streams genericiooptions.IOStreams, clock clock.Clock) *cobra.Command {
...
func (o *JobSetOptions) Complete(clientGetter util.ClientGetter) error {
	var err error
